<div id="myCarousel" class="carousel slide">
      <!-- Indicators -->
        ...
        <div class="carousel-inner">
          <div class="item active">
            <div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide5.jpg');"></div>
            <div class="carousel-caption">
              <h1>Modern Business - A Bootstrap 3 Template</h1>
            </div>
          </div>
          <div class="item">
            <div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide6.jpg');"></div>
            <div class="carousel-caption">
              <h1>Ready to Style &amp; Add Content</h1>
            </div>
          </div>
          <div class="item">
            <div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide7.jpg');"></div>
            <div class="carousel-caption">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html"><img class="img-responsive img-home-portfolio" src="{$base_url}{$theme_path}img/slide1.jpg"></a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html"><img class="img-responsive img-home-portfolio" src="{$base_url}{$theme_path}img/slide2.jpg"></a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html"><img class="img-responsive img-home-portfolio" src="{$base_url}{$theme_path}img/slide3.jpg"></a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html"><img class="img-responsive img-home-portfolio" src="{$base_url}{$theme_path}img/slide4.jpg"></a>
          </div>
          <div class="col-lg-4 col-md-4 col-sm-6">
            <a href="portfolio-item.html"><img class="img-responsive img-home-portfolio" src="{$base_url}{$theme_path}img/slide1.jpg"></a>
          </div>
    ...
    <div class="section-colored">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <img class="img-responsive" src="{$base_url}{$theme_path}img/slide3.jpg">
          </div>
        </div><!-- /.row -->
    ...
    <div class="section">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">
            <img class="img-responsive" src="{$base_url}{$theme_path}img/slide2.jpg">
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6">
            <h2>Modern Business Features Include:</h2>
            <ul>
