<div id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item active">
			<div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide2.jpg');"></div>
			<div class="carousel-caption">
				<h1>A Full-Width Image Slider Template</h1>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide1.jpg');"></div>
			<div class="carousel-caption">
				<h1>Caption 2</h1>
			</div>
		</div>
		<div class="item">
			<div class="fill" style="background-image:url('{$base_url}{$theme_path}img/slide4.jpg');"></div>
			<div class="carousel-caption">
				<h1>Caption 3</h1>
			</div>
		</div>
